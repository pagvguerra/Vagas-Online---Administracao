...
public class EnderecoDAO {
	...
	public static EnderecoBean buscaEnderecoPorEstacionamento(int idEndereco) {
		...
		try {
			...
			if(rs.next()) {
				...
				//COORDENADA
				CoordenadaBean coordenadaBean = new CoordenadaBean();
				coordenadaBean.setLatitude(rs.getString("LATITUDE"));
				coordenadaBean.setLongitude(rs.getString("LONGITUDE"));
	...
	public int inserir(EnderecoBean obj) {
		...
		try {
			...
			pstmt.setInt(10, obj.getPaisBean().getId());
			pstmt.executeUpdate();
