...
<html>
	<head>
		...
		<title>ESTACIONAMENTO ONLINE - CADASTRO DE TIPO DE PAGAMENTO</title>
	...
	<body>
		...
		<div class="container">
			<div class="col-sm-10">
				...
				<fieldset>
				<legend><B>TELA DE CADASTRO DE TIPO DE PAGAMENTO</B></legend>
				<br><br>
					<div class="form-group">
						<b>Tipo de Pagamento cadastrado com sucesso para este estacionamento</b>
					</div>
					<br>
					<form>
