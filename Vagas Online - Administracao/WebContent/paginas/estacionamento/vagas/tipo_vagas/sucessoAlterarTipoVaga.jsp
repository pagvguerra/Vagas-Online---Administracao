...
<html>
	<head>
		...
		<title>ESTACIONAMENTO ONLINE - ALTERAÇÃO DE TIPO DE VAGAS DE ESTACIONAMENTO</title>
	...
	<body>
		...
		<div class="container">
			<div class="col-sm-10">
				...
				<fieldset>
				<legend><B>TELA DE ALTERAÇÃO DE TIPO DE VAGAS DO ESTACIONAMENTO</B></legend>
				<br><br>
					<div class="form-group">
						<b>Tipo de vagas alterada com sucesso</b>
					</div>
					<br>
					<form>
