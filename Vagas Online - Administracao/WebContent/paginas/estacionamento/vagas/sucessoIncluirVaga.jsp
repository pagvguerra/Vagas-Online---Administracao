...
<html>
	<head>
		...
		<title>ESTACIONAMENTO ONLINE - CADASTRO DE VAGAS DE ESTACIONAMENTO</title>
	...
	<body>
		...
		<div class="container">
			<div class="col-sm-10">
				...
				<fieldset>
				<legend><B>TELA DE CADASTRO DE VAGA DO ESTACIONAMENTO</B></legend>
				<br><br>
					<div class="form-group">
						<b>Vaga cadastrada com sucesso</b>
					</div>
					<br>
					<form>
