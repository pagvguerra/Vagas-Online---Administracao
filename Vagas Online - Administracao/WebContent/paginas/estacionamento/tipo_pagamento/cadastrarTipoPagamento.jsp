					...
					<input name="idEstacionamento" id="idEstacionamento" type="hidden" value="${idEstacionamento}">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<input type="checkbox" name="tipoPagamento" id="tipoPagamentoVisa" value="2" />&nbsp;<img src="${pageContext.request.contextPath}/estaticos/images/visa.png" title="cartão visa">&nbsp;&nbsp;
								<input type="checkbox" name="tipoPagamento" id="tipoPagamentoMaster" value="3" />&nbsp;<img src="${pageContext.request.contextPath}/estaticos/images/master.png" title="cartão mastercard">&nbsp;&nbsp;
								<input type="checkbox" name="tipoPagamento" id="tipoPagamentoAmex" value="4" />&nbsp;<img src="${pageContext.request.contextPath}/estaticos/images/amex.png" title="cartão american express">
							</div>
							<br><br><br><br><br><br>
							<center>
