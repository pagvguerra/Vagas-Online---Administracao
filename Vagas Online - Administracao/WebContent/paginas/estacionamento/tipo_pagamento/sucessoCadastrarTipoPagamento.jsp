...
<html>
	<head>
		...
		<title>ESTACIONAMENTO ONLINE - CADASTRO DE PAGAMENTO</title>
	...
	<body>
		...
		<div class="container">
			<div class="col-sm-10">
				...
				<fieldset>
				<legend><B>TELA DE CADASTRO DO PAGAMENTO</B></legend>
				<br><br>
					<div class="form-group">
						<b>Pagamento cadastrado com sucesso</b>
					</div>
					<br>
					<form>
						<input type="hidden" name="acao" id="acao" value="LISTAR_TODOS">
						<input type="submit" id="botaoVoltar" value="VOLTAR PARA A LISTA DE PAGAMENTO" class="btn btn-info"/>
					</form>
				</fieldset>	
			</div>
		</div>		
